...
with open('/Users/rachelhill/Desktop/sports.json', 'w') as f:
    json.dump(sports, f, indent=4)

"""
#Bring in sports data from API
with open('/Users/rachelhill/Desktop/sports.json') as f:
    sports = json.load(f)    
...
olympics = pd.read_csv('/Users/rachelhill/Desktop/olympics.csv', encoding='latin-1')
